    ...
    <>
      ...
      <section className="mx-auto max-w-3xl px-4 md:px-8 py-20 space-y-8 text-lg leading-relaxed">
        <p>
          ...
          it belonged in a giftshop instead of a rotation. We grew up in sneakers and streetwear. We
          also grew up in scripture. The two never had to compete — but the merch never caught up.
        </p>
        <p>
        ...
        <p>
          ...
          slogan and it's not a season. It's a pursuit. And it doesn't end.
        </p>
